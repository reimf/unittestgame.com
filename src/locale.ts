...
export class Locale {
    ...
    private pick(options: LocalizedText): Translation {
        return new Translation(options[this.lng])
    }

    public welcomeToUnittestgame(): Translation {
        return this.pick({
    ...
    public learnToWriteEffectiveUnitTests(): Translation {
        return this.pick({
    ...
    public whatDoYouWantToDo(): Translation {
        return this.pick({
    ...
    public level(index: number, total: number, description: Translation, emoji: string): Translation {
        return this.pick({
    ...
    public iWantToPlayTheNextLevel(level: Translation): Translation {
        return this.pick({
    ...
    public iPlayedAllTheLevels(): Translation {
        return this.pick({
    ...
    public wellDoneYouCanCloseThisTab(): Translation {
        return this.pick({
    ...
    public currentLevel(): Translation {
        return this.pick({
            en: 'Current Level',
            nl: 'Huidige Level',
        })
    ...
    public youHaveNotWrittenAnyUnitTestsYet(): Translation {
        return this.pick({
    ...
    public iWantToAddThisUnitTest(): Translation {
        return this.pick({
    ...
    public iWantToSubmitTheUnitTests(): Translation {
        return this.pick({
    ...
    public checkingTheNewUnitTest(): Translation {
        return this.pick({
    ...
    public iCheckedTheNewUnitTest(): Translation {
        return this.pick({
    ...
    public checkingTheUnitTests(): Translation {
        return this.pick({
    ...
    public iCheckedTheUnitTests(): Translation {
        return this.pick({
    ...
    public iDidNotAddTheUnitTest(): Translation {
        return this.pick({
    ...
    public testDrivenDevelopment(): Translation {
        return this.pick({
    ...
    public definitionTDD(): Translation {
        return this.pick({
    ...
    public currentFunction(): Translation {
        return this.pick({
            en: 'Current Function',
            nl: 'Huidige Functie',
        })
    ...
    public iAddedTheUnitTestButTheCurrentFunctionAlreadyPassedThisUnitTest(): Translation {
        return this.pick({
    ...
    public tryToWriteUnitTestsThatFail(): Translation {
        return this.pick({
    ...
    public iAddedTheUnitTestAnd(): Translation {
        return this.pick({
    ...
    public theCurrentFunctionIsNotAccordingToTheSpecification(): Translation {
        return this.pick({
    ...
    public itProducesTheFollowingIncorrectResult(): Translation {
        return this.pick({
    ...
    public tryToWriteAUnitTestThatIsAccordingToTheSpecification(numberOfUnitTestsStillNeeded: number): Translation {
        return this.pick({
    ...
    public theCurrentFunctionIsIndeedAccordingToTheSpecification(): Translation {
        return this.pick({
    ...
    public mutationTesting(): Translation {
        return this.pick({
            en: 'Mutation Testing',
            nl: 'Mutation Testing',
        })
    ...
    public definitionMT(): Translation {
        return this.pick({
    ...
    public theFunction(): Translation {
        return this.pick({
            en: 'The Function',
            nl: 'De Functie',
        })
    ...
    public finishedLevels(): Translation {
        return this.pick({
            en: 'Finished levels',
            nl: 'Voltooide levels',
        })
    ...
    public iAddedTheUnitTestButTheLineCoverageDidNotIncrease(): Translation {
        return this.pick({
    ...
    public tryToWriteUnitTestsThatCover(): Translation {
        return this.pick({
    ...
    public iAddedTheUnitTestAndIShowedTheLineCoverage(): Translation {
        return this.pick({
    ...
    public theFunctionIsNotFullyTested(): Translation {
        return this.pick({
    ...
    public aMutationOfTheFunction(): Translation {
        return this.pick({
    ...
    public tryToWriteAUnitTestThatPasses(numberOfUnitTestsStillNeeded: number): Translation {
        return this.pick({
    ...
    public theFunctionIsIndeedFullyTested(): Translation {
        return this.pick({
    ...
    public aSmartphoneNormallyOperatesInNormalMode(): Translation {
        return this.pick({
    ...
    public inThisExampleYouOnlyHaveToClickTheGreenButton(): Translation {
        return this.pick({
    ...
    public meanwhileKeepAnEyeOnTheYellowMarkedChangesInTheSidebar(): Translation {
        return this.pick({
    ...
    public theSpecificationContainsTheNumber20(): Translation {
        return this.pick({
    ...
    public theCurrentFunctionNowAlwaysReturnsNormalMode(): Translation {
        return this.pick({
    ...
    public theCurrentFunctionNowSometimesReturnsNormalModeAndSometimesLowPowerMode(): Translation {
        return this.pick({
    ...
    public theCurrentFunctionNowReturnsNormalModeOnlyForBatteryLevel20Percent(): Translation {
        return this.pick({
    ...
    public submitTheUnitTestsAgainToSeeIfTheCurrentFunctionIsAccordingToTheSpecification(): Translation {
        return this.pick({
    ...
    public theCurrentFunctionNowReturnsLowPowerModeOnlyForBatteryLevel19Percent(): Translation {
        return this.pick({
    ...
    public submitTheUnitTestsAgainToSeeIfTheCurrentFunctionIsFinallyAccordingToTheSpecification(): Translation {
        return this.pick({
    ...
    public congratulationsNowYouUnderstandTheBasicsOfTestDrivenDevelopment(): Translation {
        return this.pick({
    ...
    public theFunctionContainsTheNumber20(): Translation {
        return this.pick({
    ...
    public theFunctionDoesNotAlwaysReturnNormalMode(): Translation {
        return this.pick({
    ...
    public allLinesInTheFunctionAreCoveredNow(): Translation {
        return this.pick({
    ...
    public thisMutationOnlyReturnsNormalModeIfTheBatteryLevelIsExactly20Percent(): Translation {
        return this.pick({
    ...
    public submitTheUnitTestsAgainToSeeIfTheFunctionIsFullyTestedNow(): Translation {
        return this.pick({
    ...
    public thisMutationOnlyReturnsLowPowerModeIfTheBatteryLevelIsExactly19Percent(): Translation {
        return this.pick({
    ...
    public submitTheUnitTestsAgainToSeeIfTheFunctionIsFinallyFullyTestedNow(): Translation {
        return this.pick({
    ...
    public congratulationsNowYouUnderstandTheBasicsOfMutationTesting(): Translation {
        return this.pick({
    ...
    public returnTrueIfTheNumberIsEvenAndFalseIfItIsOdd(): Translation {
        return this.pick({
    ...
    public returnFizzIfTheNumberIsDivisibleBy3(): Translation {
        return this.pick({
    ...
    public returnTrueIfTheTextRepresentsAFloatAndFalseIfItDoesnt(): Translation {
        return this.pick({
    ...
    public returnTrueIfTheYearIsALeapYearAndFalseIfItIsNot(): Translation {
        return this.pick({
    ...
    public returnTrueIfThePasswordIsStrongAndFalseIfItIsNot(): Translation {
        return this.pick({
    ...
    public theFunctionReceivesTheSpeedInKilometersPerHourWithAtMostOneDecimal(): Translation {
        const display = (
            '+-------------------+\n' +
            '|  X   XXXX   XXXX  |\n' +
            '|  X   X  X   X  X  |\n' +
    ...
    public returnTheTypeOfTheTriangle(): Translation {
        return this.pick({
    ...
    public returnTrueIfTheAgeIs18YearsOrOverAndFalseIfTheAgeIsUnder18(): Translation {
        return this.pick({
