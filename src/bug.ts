export class Bug {
  private size = 32
  private beetle = document.createElement('div')
  private currentPosition = { x: window.innerWidth / 2, y: window.innerHeight / 2 }
  private targetPosition = { x: this.currentPosition.x, y: this.currentPosition.y }
