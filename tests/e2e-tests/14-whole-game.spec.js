...
test.describe('whole game', () => {
    test('plays whole game', async ({ browser }) => {
        ...
        const exampleTestDrivenDevelopment = new TestDrivenDevelopment(locale, batteryLevel, 1);
        const exampleMutationTesting = new MutationTesting(locale, batteryLevel, 3);
