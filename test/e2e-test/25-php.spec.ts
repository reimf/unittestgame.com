...
test.describe('php programming language', () => {
    test('has the simplest candidate rendered in PHP format in the current function panel', async ({ page }) => {
        await page.goto('/?speed=fast&picker=fixed&programmingLanguage=php')
    ...
    test('has a bool return type in the current function panel', async ({ page }) => {
        await page.goto('/?speed=fast&programmingLanguage=php&setitem=level-battery-level-finished:1')
    ...
    test('has an int parameter type in the current function panel of Speed Display', async ({ page }) => {
        await page.goto('/?speed=fast&programmingLanguage=php&setitem=level-battery-level-finished:1&setitem=level-voting-age-finished:1&setitem=level-even-or-odd-finished:1&setitem=level-review-finished:1&setitem=level-fizz-buzz-finished:1&setitem=level-leap-year-finished:1&setitem=level-triangle-type-finished:1')
