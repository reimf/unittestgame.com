...
test.describe('level emojis', () => {
    test('has level overview panel', async ({ page }) => {
        await page.goto('/en/game?speed=fast&setitem=penalties-level-battery-level:0&setitem=penalties-level-voting-age:1&setitem=penalties-level-wind-scale:2&setitem=penalties-level-review:3')
