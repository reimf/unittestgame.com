...
test.describe('submit no unit tests with radio variable unit', () => {
    test.beforeEach(async ({ page }) => {
        await page.goto('/en/game?speed=fast&picker=fixed&setitem=penalties-level-battery-level:0&setitem=penalties-level-voting-age:0&setitem=penalties-level-wind-scale:1')
