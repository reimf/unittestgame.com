...
test.describe('submit no unit tests with radio variable unit', () => {
    test.beforeEach(async ({ page }) => {
        await page.goto('/game.html?speed=fast&picker=fixed&setitem=level-battery-level-finished:1&setitem=level-voting-age-finished:1&setitem=level-wind-scale-finished:1')
